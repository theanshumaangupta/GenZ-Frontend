    ...
    return (
        <div data-nav-bg="light" className="w-full min-h-screen bg-white md:p-4 text-white">
            <div className="w-full h-full min-h-screen md:rounded-2xl relative flex flex-col gap-10 md:gap-0 md:flex-row bg-[#4B69F0] pb-[40vh] md:pb-0 py-5 md:py-20 px-5 md:px-10 overflow-hidden">
                <img src="assets/logo.svg" className="absolute bottom-0 left-0 invert-100 w-full " alt="" />
                <img src="assets/smile-blue.svg" className="absolute w-[20%] md:w-40 bottom-30  left-[15%] -rotate-20 z-50" alt="" />

                <img src="assets/heart.svg" className="absolute w-[20%] md:w-40 bottom-20  left-[35%] -rotate-20 z-50" alt="" />
                <img src="assets/pencil-hand-heart.svg" className="absolute w-[20%] md:w-45 bottom-10  left-[46%]  rotate-20 z-50" alt="" />
                <img src="assets/thumb.svg" className="absolute w-[20%] md:w-28 bottom-40  left-[60%] +rotate-0 z-50" alt="" />

                <img src="assets/pencil-camera.svg" className="absolute w-[20%] md:w-40 bottom-50  left-[80%] -rotate-20 z-50" alt="" />
