export default function Hero() {
    return (
        <div className="md:p-[10px] w-full h-screen">
            <section data-nav-bg="light" className="hero-sec   text-white hero bg-center w-full h-full md:rounded-3xl relative bg-red-500  flex flex-col justify-center bg-no-repeat bg-cover items-center  text-center"
