                ...
                <nav className="fixed z-1000 top-0 p-5 md:px-10 md:py-10 flex justify-between items-center w-full">
                    <div className="relative">
                        <div className="text-[25px] md:text-[35px] font-[1000] font-sans z-10 relative group ">
                            <h1 className="group-hover:invert-100 relative top-0 left-0 group-hover:top-2 group-hover:left-2 transition-all duration-500 ">work</h1>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 52 48"
                                fill="none"
                                className="no-invert -z-10 -top-0 -left-4 group-hover:top-5 group-hover:left-0 transition-all duration-500  w-[60%] max-w-[10rem] absolute invert-0 group-hover:rotate-180  "
                            >
                                <path
                                    fill="#F5693C"
                            ...
                            <div
                                className="absolute pt-25 -z-100 -top-4 -left-4 w-80 md:w-96 bg-primary text-black text-sm rounded-3xl p-4 overflow-hidden origin-top-left scale-0 group-hover:scale-100 transition-transform duration-300 flex flex-col gap-4 "
                            >
                                <div className="flex items-center gap-4">
                                    <img src="assets/img/work (2).webp" className="w-25 h-25 rounded-xl object-cover" alt="" />
                                    <div className="flex flex-col gap-2 justify-between items-start">
                                        <h1 className="bg-[#A0325A] p-1 rounded-2xl text-sm font-medium">douwe egbert</h1>
                                        <h1 className="text-[15px] font-semibold text-hover-wobble">hello we make web for u</h1>
                                    </div>
                                </div>
                                ...
                                <div className="rounded bg-black text-white w-full h-10 flex justify-center items-center">View More !</div>
                            </div>
